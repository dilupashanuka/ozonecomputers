    ...
    >
      <div className="relative">
        ...
        <motion.div 
          ...
          className="relative w-16 h-16 md:w-24 md:h-24 bg-[#25D366] text-white rounded-[2.5rem] flex items-center justify-center shadow-[0_30px_60px_-10px_rgba(37,211,102,0.6)] transition-all duration-700 group-hover:scale-110 group-hover:rotate-12 border-4 border-white/20 relative overflow-hidden"
        >
        ...
        <div className="absolute right-full mr-10 top-1/2 -translate-y-1/2 hidden md:block opacity-0 group-hover:opacity-100 transition-all duration-700 pointer-events-none transform translate-x-10 group-hover:translate-x-0">
          <div className="bg-[#050811]/90 px-10 py-4 rounded-[2.5rem] whitespace-nowrap shadow-[0_30px_60px_rgba(0,0,0,0.8)] border border-white/10 backdrop-blur-3xl">
            <span className="text-[10px] font-black text-white uppercase tracking-[0.5em] flex items-center gap-4 italic">
