...
export function ShopSidebar({ currentCategory, categories, availableSpecs, availableBrands }: ShopSidebarProps) {
  ...
  return (
    <div className="space-y-12 sticky top-32">
      ...
      <div className="space-y-8">
        {!currentInventory ? (
            ...
            <div className="grid gap-4">
              <Link
                ...
                className={cn(
                  ...
                  !currentCategory 
                    ? "bg-primary text-white border-primary shadow-[0_10px_30px_rgba(239,68,68,0.3)] italic"
              ...
              {inventories.map((inv) => (
                <Link
                  ...
                  scroll={false}
                  className="flex items-center gap-5 p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 text-slate-500 hover:border-primary/50 hover:text-white transition-all duration-500 group"
                >
                  <div className={cn("w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center transition-all duration-500 group-hover:bg-primary group-hover:text-white", inv.color)}>
                    {inv.icon}
                  </div>
          ...
          <div className="animate-in slide-in-from-left-8 duration-700">
            ...
            <div className="p-8 rounded-[3rem] bg-white/[0.03] border border-white/5 mb-10 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-24 h-24 bg-primary/5 blur-[40px] pointer-events-none" />
              <div className={cn("w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center mb-6 transition-all duration-500 group-hover:bg-primary group-hover:text-white", activeInv?.color)}>
                {activeInv?.icon}
              </div>
              <h3 className="text-3xl font-black text-white tracking-tighter uppercase mb-1 italic">{activeInv?.name}</h3>
              ...
              <Link
                ...
                className={cn(
                  ...
                  !currentCategory 
                    ...
                    : "bg-white/[0.03] border-white/5 text-slate-600 hover:text-white hover:border-white/20"
                )}
              >
                All {activeInv?.name}
              </Link>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    currentCategory === cat.slug 
                      ...
                      : "bg-white/[0.02] border-white/5 text-slate-600 hover:text-white hover:border-white/20"
                  )}
                >
                  {cat.name}
      ...
      <div className="space-y-10 p-10 bg-white/[0.02] rounded-[3.5rem] border border-white/5 relative overflow-hidden group">
        ...
        <div className="space-y-12 relative z-10 pt-6">
          <div className="px-3">
            <Slider 
              ...
              className={cn(
                "w-full",
                "[&_[data-slot=slider-track]]:bg-slate-900 [&_[data-slot=slider-track]]:h-2",
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <div className="p-6 rounded-[1.5rem] bg-black/40 border border-white/5 flex flex-col group/box hover:border-primary/40 transition-all duration-500">
                <span className="text-[9px] text-primary font-black uppercase mb-2">LKR</span>
                <span className="text-xl font-black text-white group-hover/box:scale-105 transition-transform origin-left italic">
            ...
            <div className="space-y-3 text-right">
              ...
              <div className="p-6 rounded-[1.5rem] bg-black/40 border border-white/5 flex flex-col group/box hover:border-primary/40 transition-all duration-500">
                <span className="text-[9px] text-primary font-black uppercase mb-2">LKR</span>
                <span className="text-xl font-black text-white group-hover/box:scale-105 transition-transform origin-right italic">
      ...
      {((availableSpecs && Object.keys(availableSpecs).length > 0) || (availableBrands && availableBrands.length > 0)) && (
        <div className="space-y-10 p-10 bg-white/[0.02] rounded-[3.5rem] border border-white/5">
          <h3 className="text-[10px] font-black text-primary uppercase tracking-[0.5em] flex items-center gap-3 italic">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isActive 
                            ? "bg-primary text-white border-primary shadow-[0_0_20px_rgba(239,68,68,0.4)]"
                            : "bg-white/5 border-white/5 text-slate-500 hover:border-primary/50 hover:text-white"
                        )}
                      >
                        {brand}
                      </button>
      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-4">
          <Link href="/products" scroll={false} className="flex items-center justify-center gap-4 w-full h-16 rounded-[1.5rem] bg-white/[0.03] border border-white/5 text-slate-500 hover:text-white hover:border-primary transition-all duration-500 text-[10px] font-black uppercase tracking-[0.3em] group italic">
          ...
          <div className="p-10 rounded-[3rem] bg-gradient-to-br from-primary/10 to-transparent border border-primary/20 relative overflow-hidden group">
            ...
            <h4 className="text-white font-black text-sm uppercase tracking-[0.2em] mb-2 italic">OZONE VERIFIED</h4>
