    ...
    <AnimatePresence mode="wait">
      ...
      >
        {!products || products.length === 0 ? (
          <div className="text-center py-56 bg-white/[0.01] rounded-[5rem] border border-dashed border-white/5 relative overflow-hidden group shadow-2xl">
            ...
            <div className="w-40 h-40 rounded-[3rem] bg-white/[0.03] border border-white/5 flex items-center justify-center mx-auto mb-12 transition-all duration-1000 group-hover:bg-primary/10 group-hover:scale-110 shadow-2xl">
              <Terminal className="w-16 h-16 text-slate-800 group-hover:text-primary transition-colors duration-700" />
            </div>
            <h3 className="text-5xl md:text-7xl font-black text-white mb-8 uppercase tracking-tighter italic drop-shadow-2xl">LAB SECTOR <span className="text-primary italic">VACANT</span></h3>
            ...
            <div className="mt-16 inline-flex items-center gap-6 px-10 py-4 bg-white/[0.02] rounded-full border border-white/5">
