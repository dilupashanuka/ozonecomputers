    ...
    return (
      <button
        ...
        className={cn(
          ...
          size === 'lg' 
            ? "h-24 w-24 bg-white/[0.03] rounded-2xl border border-white/5 text-slate-800 shadow-2xl"
            : "w-14 h-14 bg-black/60 backdrop-blur-3xl rounded-[1.25rem] border border-white/10 text-slate-800"
        )}
      >
        ...
        size === 'lg' 
          ? `h-24 w-24 rounded-2xl border-2 backdrop-blur-3xl shadow-2xl ${
              isWishlisted 
                ...
                : 'border-white/5 bg-white/[0.01] text-slate-800 hover:text-primary hover:border-primary/50'
            }`
          : `w-14 h-14 rounded-[1.25rem] backdrop-blur-3xl transition-all duration-700 border-2 ${
              isWishlisted 
                ...
                : 'bg-black/80 border-white/5 text-slate-800 hover:text-primary hover:border-primary/50 opacity-0 group-hover:opacity-100'
            }`
      )}
    >
      <Heart className={cn(
