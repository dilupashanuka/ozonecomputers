...
export function ReviewsSection({ reviews = [] }: { reviews: Review[] }) {
  ...
  return (
    <section className="py-64 relative overflow-hidden bg-[#050811]">
      {/* Decorative glows */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-48 space-y-10">
          ...
          <h2 className="text-[5rem] md:text-[10rem] font-black text-white tracking-tighter leading-[0.8] uppercase italic drop-shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14">
          {reviews.map((review, idx) => (
            <div key={review.id} className="p-16 rounded-[5rem] bg-white/[0.01] border border-white/5 relative group hover:border-primary/60 transition-all duration-1000 hover:-translate-y-6 shadow-[0_50px_150px_rgba(0,0,0,0.9)]">
              ...
              <div className="flex items-center gap-8 pt-12 border-t border-white/5 relative z-10">
                <div className="w-20 h-20 rounded-3xl overflow-hidden bg-white/[0.02] border border-white/5 flex items-center justify-center text-primary font-black relative group-hover:border-primary/50 transition-all duration-700 grayscale group-hover:grayscale-0 shadow-2xl">
                  {review.avatar_url ? (
                ...
                <div className="space-y-3">
                  <h4 className="text-white font-black uppercase tracking-tighter italic text-2xl leading-none group-hover:text-primary transition-colors duration-700">{review.customer_name}</h4>
        ...
        {/* Lab Stats */}
        <div className="mt-56 grid grid-cols-2 lg:grid-cols-4 gap-14 p-16 bg-white/[0.01] rounded-[6rem] border border-white/5 relative overflow-hidden group shadow-[0_60px_200px_rgba(0,0,0,1)]">
