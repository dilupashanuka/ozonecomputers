      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="space-y-20">
          ...
          <div className="space-y-10">
            ...
            <h1 className="text-7xl md:text-9xl font-black text-slate-900 tracking-tighter leading-[0.8] uppercase italic drop-shadow-[0_20px_50px_rgba(0,0,0,0.8)]">TERMS & <br /><span className="text-primary italic">PROTOCOLS</span></h1>
