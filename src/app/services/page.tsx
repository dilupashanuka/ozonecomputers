  ...
  return (
    <div className="min-h-screen bg-[#050811] pb-64 relative overflow-hidden">
      ...
      <div className="pt-64 pb-48 relative z-10">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl space-y-12">
            ...
            <h1 className="text-[5rem] md:text-[10rem] font-black text-white tracking-tighter leading-[0.8] uppercase italic drop-shadow-2xl">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-14">
          {services && services.length > 0 ? (
            services.map((service, idx) => (
              <div key={service.id} className="group p-16 bg-white/[0.01] rounded-[4.5rem] border border-white/5 hover:border-primary/60 transition-all duration-1000 relative overflow-hidden shadow-[0_50px_150px_rgba(0,0,0,0.8)] hover:-translate-y-6">
                ...
                <div className="relative z-10 space-y-10">
                  <div className="w-24 h-24 rounded-[2rem] bg-white/[0.02] border border-white/5 flex items-center justify-center text-primary transition-all duration-1000 group-hover:scale-110 group-hover:rotate-12 group-hover:bg-primary group-hover:text-white group-hover:shadow-[0_25px_60px_rgba(239,68,68,0.6)]">
                    {getIcon(service.icon || 'settings')}
                  </div>
                  
                  <div className="space-y-4">
                    <h3 className="text-4xl font-black text-white tracking-tighter uppercase italic group-hover:text-primary transition-colors duration-700">
                      {service.title}
                    </h3>
                    {service.price_range && (
                  ...
                  <div className="pt-12 border-t border-white/5">
                    <Link 
                      ...
                      target="_blank"
                      className="flex items-center justify-between w-full p-8 bg-white/[0.02] border border-white/5 rounded-3xl text-[11px] font-black uppercase tracking-[0.4em] text-white hover:bg-primary hover:border-primary transition-all duration-700 italic shadow-2xl"
                    >
                      INITIALIZE_INTEL
             ...
             <div className="col-span-full py-64 text-center bg-white/[0.01] rounded-[6rem] border-2 border-dashed border-white/5 group shadow-[0_50px_150px_rgba(0,0,0,0.9)]">
                 <div className="w-32 h-32 rounded-[2rem] bg-white/[0.02] border border-white/5 flex items-center justify-center mx-auto mb-12 group-hover:bg-primary/10 transition-all duration-1000">
                    <Terminal className="w-14 h-14 text-slate-900 group-hover:text-primary transition-colors" />
                 </div>
                <h2 className="text-4xl font-black text-white uppercase tracking-tighter italic mb-6">LAB SERVICES OFFLINE</h2>
        ...
        {/* Support CTA */}
        <div className="mt-64 relative p-20 md:p-40 rounded-[6rem] overflow-hidden border border-white/5 shadow-[0_60px_200px_rgba(0,0,0,1)] bg-white/[0.01]">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-24">
            <div className="max-w-3xl space-y-12 text-center lg:text-left">
               <div className="inline-flex items-center gap-6 px-10 py-4 rounded-full bg-white/[0.02] border border-white/10 italic shadow-2xl">
                  <ShieldCheck className="w-6 h-6 text-primary" />
                  <span className="text-[11px] font-black text-white uppercase tracking-[0.5em] leading-none">ELITE SOLUTION PROTOCOL</span>
               </div>
              <h2 className="text-6xl md:text-[6rem] font-black text-white tracking-tighter leading-[0.8] uppercase italic drop-shadow-2xl">BESPOKE LAB <br /> <span className="text-primary italic">SYSTEMS?</span></h2>
            ...
            <Link 
              ...
              className="h-24 px-16 md:h-28 md:px-20 bg-primary text-white font-black uppercase tracking-[0.4em] rounded-[2.5rem] text-xs md:text-sm shadow-[0_30px_70px_rgba(239,68,68,0.5)] flex items-center gap-6 hover:shadow-[0_0_100px_rgba(239,68,68,0.8)] transition-all duration-700 justify-center w-full lg:w-auto transform hover:-translate-y-3 italic group"
            >
