  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2">
        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900">Social Feed Control</h1>
        <p className="text-slate-600 font-medium">Link your latest Facebook updates to the live website feed.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <CardContent>
            <form action={addSocialPost} className="space-y-4">
              <div className="space-y-2">
                <Label className="text-slate-700 font-bold text-[11px] uppercase tracking-wider">Facebook Post URL</Label>
                <Input 
                  name="fb_post_url" 
                  required 
        ...
        <div className="lg:col-span-2 space-y-4">
          {posts?.map((post) => (
            <Card key={post.id} className="bg-white/40 border-black/5 backdrop-blur-md">
              <CardContent className="p-4 flex items-center gap-4">
                <div className="p-3 rounded-lg bg-black/5 border border-black/5 text-blue-400">
                  <Facebook className="w-5 h-5" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-bold text-slate-900 truncate uppercase tracking-widest">Active Post Feed</p>
                ...
                <div className="flex items-center gap-2">
                  <a 
                    ...
                    className="p-2 rounded-lg bg-black/5 text-slate-600 hover:text-slate-900 transition-colors"
                  >
                  ...
                  <form action={deleteSocialPost}>
                    ...
                    <Button 
                      ...
                      size="icon" 
                      type="submit"
                      className="rounded-lg text-slate-600 hover:text-red-400 hover:bg-red-400/10"
                    >
