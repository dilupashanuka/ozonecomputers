  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2">
        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900">Global Partners</h1>
        <p className="text-slate-600 font-medium">Manage authorized retailer & brand logos for the homepage.</p>
      </div>
          ...
          <CardContent>
            <form action={addPartner} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-slate-700 font-bold text-[11px] uppercase tracking-wider">Brand Name (Optional)</Label>
                <Input 
                  id="name" 
                  name="name" 
              ...
              <div className="space-y-2">
                <Label className="text-slate-700 font-bold text-[11px] uppercase tracking-wider">Brand Logos</Label>
        ...
        <div className="lg:col-span-2">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {partners?.map((partner) => (
              <div key={partner.id} className="group relative aspect-square glass rounded-[2rem] border-black/5 overflow-hidden flex items-center justify-center p-6 transition-all hover:border-primary/50">
            ...
            {!partners?.length && (
              <div className="col-span-full py-32 glass rounded-[3rem] border border-dashed border-black/10 flex flex-col items-center justify-center text-slate-600 gap-4">
