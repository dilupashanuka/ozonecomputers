  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2">
        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900">Dynamic Site Content</h1>
        <p className="text-slate-600 font-medium">Control the text and structure of your policy and information pages.</p>
      </div>
          ...
          <CardContent>
            <form action={updateSiteContent} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-slate-700 font-bold text-[11px] uppercase tracking-wider">Page Content (JSON Format)</Label>
                <Textarea 
                  name="content" 
                  defaultValue={getPageContent('about')} 
                  rows={15}
                  className="bg-black/5 border-black/10 text-slate-700 font-mono text-xs focus:border-blue-500/50 resize-none"
                />
              </div>
            ...
            <form action={updateSiteContent} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  rows={15}
                  className="bg-black/5 border-black/10 text-slate-700 font-mono text-xs focus:border-emerald-500/50 resize-none"
                />
              </div>
      ...
      <Card className="bg-black/5 border-black/5 border-dashed">
