  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2">
        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900">Inventory Header Manager</h1>
        <p className="text-slate-600 font-medium">Manage the permanent text and dynamic background images for the Shop page.</p>
      </div>
            ...
            <CardContent>
              <form action={updateInventoryHeaderText} className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-slate-700 font-bold text-[11px] uppercase tracking-wider">Main Title</Label>
                  <Input 
                    name="title" 
                ...
                <div className="space-y-2">
                  <Label className="text-slate-700 font-bold text-[11px] uppercase tracking-wider">Subtitle</Label>
                  <Textarea 
                    name="subtitle" 
          ...
          <Card className="bg-white/40 border-black/5 backdrop-blur-md">
            ...
            <CardContent>
              <form action={addInventorySlide} className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-slate-700 font-bold text-[11px] uppercase tracking-wider text-blue-400">Select Images (Bulk Upload)</Label>
