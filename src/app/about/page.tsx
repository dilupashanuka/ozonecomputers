    ...
    <div className="min-h-screen bg-slate-50 pb-64 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 space-y-64 relative z-10">
        ...
        <section className="grid lg:grid-cols-2 gap-32 items-center">
          <div className="relative aspect-square rounded-[5rem] overflow-hidden bg-black/[0.01] border border-black/5 group shadow-[0_80px_200px_rgba(0,0,0,1)] hover:border-primary/40 transition-all duration-1000">
             <Image 
            ...
            <div className="absolute bottom-12 left-12 right-12 p-12 bg-black/[0.02] backdrop-blur-3xl rounded-[3.5rem] border border-black/5 shadow-2xl">
              ...
              <p className="text-slate-900 font-black italic text-2xl md:text-4xl leading-none uppercase tracking-tighter drop-shadow-2xl">
          ...
          <div className="space-y-16">
            <div className="space-y-8">
              <h2 className="text-6xl md:text-9xl font-black text-slate-900 tracking-tighter uppercase italic leading-none drop-shadow-2xl">CORE VISION</h2>
            ...
            <div className="pt-12">
              <Link href="/products" className="group inline-flex h-28 items-center px-20 bg-primary text-slate-900 font-black uppercase tracking-[0.4em] rounded-3xl text-xs md:text-sm shadow-[0_30px_70px_rgba(239,68,68,0.5)] hover:shadow-[0_0_100px_rgba(239,68,68,0.8)] transition-all duration-700 transform hover:-translate-y-3 italic">
        ...
        <section className="space-y-32">
           <div className="text-center space-y-10">
              <h2 className="text-[5rem] md:text-[10rem] font-black text-slate-900 tracking-tighter uppercase italic leading-none drop-shadow-2xl">TRIPLE NODES</h2>
        ...
        {/* Call to Action */}
        <section className="text-center space-y-24 py-48 relative overflow-hidden rounded-[6rem] bg-black/[0.01] border border-black/5 shadow-[0_60px_200px_rgba(0,0,0,1)]">
          ...
          <h2 className="text-[5rem] md:text-[13rem] font-black text-slate-900 tracking-tighter leading-none relative z-10 uppercase italic drop-shadow-2xl">READY TO <span className="text-primary italic">EVOLVE?</span></h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-14 w-full relative z-10 px-12">
            <Link 
              ...
              className="group h-28 px-20 bg-primary text-slate-900 font-black uppercase tracking-[0.4em] rounded-3xl flex items-center justify-center gap-8 shadow-[0_30px_70px_rgba(239,68,68,0.5)] hover:shadow-[0_0_100px_rgba(239,68,68,0.8)] transition-all duration-700 w-full sm:w-auto text-xs md:text-sm transform hover:-translate-y-3 italic"
            >
            ...
            <Link 
              href="/contact" 
              className="h-28 px-20 bg-black/[0.02] border border-black/10 text-slate-900 font-black uppercase tracking-[0.4em] rounded-3xl flex items-center justify-center hover:bg-white/[0.05] transition-all duration-700 w-full sm:w-auto text-xs md:text-sm transform hover:-translate-y-3 italic backdrop-blur-3xl shadow-2xl"
            >
              LOCATE_ACTIVE_NODE
            </Link>
          </div>
...
function BranchCard({ name, desc, code }: { name: string, desc: string, code: string }) {
  return (
    <div className="p-16 bg-black/[0.01] rounded-[4.5rem] border border-black/5 hover:border-primary/60 transition-all duration-1000 group shadow-[0_50px_150px_rgba(0,0,0,0.8)] relative overflow-hidden hover:-translate-y-6">
       ...
       <div className="flex flex-col gap-12 relative z-10">
          <div className="w-24 h-24 rounded-[2rem] bg-black/[0.02] border border-black/5 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-slate-900 transition-all duration-1000 shadow-2xl group-hover:shadow-[0_20px_50px_rgba(239,68,68,0.5)]">
             <MapPin className="w-10 h-10" />
          </div>
          <div className="space-y-6">
             <h3 className="text-4xl font-black text-slate-900 uppercase italic tracking-tighter leading-none group-hover:text-primary transition-colors duration-700">{name}</h3>
...
function ValueCard({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) {
  return (
    <div className="p-20 bg-black/[0.01] rounded-[5rem] border border-black/5 hover:border-primary/60 transition-all duration-1000 space-y-12 group shadow-[0_50px_150px_rgba(0,0,0,0.8)] relative overflow-hidden hover:-translate-y-6">
      <div className="w-28 h-28 rounded-[2.5rem] bg-black/[0.02] border border-black/5 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-slate-900 transition-all duration-[1.5s] group-hover:scale-110 shadow-2xl group-hover:shadow-[0_20px_60px_rgba(239,68,68,0.6)]">
        {icon}
      </div>
      <div className="space-y-8 relative z-10">
        <h3 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic group-hover:text-primary transition-colors duration-700 leading-none">{title}</h3>
