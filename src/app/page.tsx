  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 selection:bg-primary/30">
      ...
      <div className="relative z-40 -mt-24 md:-mt-20 container mx-auto px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10 p-8 md:p-14 bg-[#0a0d14]/80 backdrop-blur-3xl rounded-[3rem] md:rounded-[4rem] border border-black/10 shadow-[0_50px_100px_rgba(0,0,0,0.8)]">
      ...
      <section className="py-48 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-32 space-y-6">
            ...
            <h2 className="text-7xl md:text-9xl font-black text-slate-900 tracking-tighter leading-[0.8] uppercase italic">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            <div className="space-y-12">
              ...
              <Link href="/services" className="inline-flex items-center gap-6 text-[10px] font-black uppercase tracking-[0.4em] text-slate-900 group italic">
                ALL LAB PROTOCOLS
                <div className="w-16 h-16 rounded-[1.5rem] border border-black/10 flex items-center justify-center group-hover:bg-primary group-hover:text-slate-900 group-hover:shadow-[0_20px_40px_rgba(239,68,68,0.4)] transition-all duration-500 transform group-hover:rotate-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {services?.map((service) => (
                <div key={service.id} className="p-10 rounded-[3rem] bg-black/[0.02] border border-black/10 hover:border-primary/40 transition-all duration-700 group relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-24 h-24 bg-primary/10 blur-3xl pointer-events-none" />
                  <div className="w-16 h-16 rounded-2xl bg-black/5 border border-black/10 flex items-center justify-center text-primary mb-8 group-hover:scale-110 group-hover:rotate-12 group-hover:bg-primary group-hover:text-slate-900 transition-all duration-500 shadow-2xl">
                    <Zap className="w-8 h-8" />
                  </div>
                  <h4 className="text-2xl font-black text-slate-900 mb-4 uppercase tracking-tighter italic group-hover:text-primary transition-colors">{service.title}</h4>
      ...
      <section className="py-20 bg-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 mb-10">
          <p className="text-center text-[11px] font-black text-slate-600 uppercase tracking-[0.5em] italic">GLOBAL PRODUCTION PARTNERS</p>
        </div>
        ...
        <div className="container mx-auto px-6 mb-24">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
            <div className="space-y-6">
              ...
              <h2 className="text-7xl md:text-9xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.8]">FRESH <br /><span className="text-primary italic">INTAKE</span></h2>
            </div>
            <Link href="/products" className="inline-flex items-center gap-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 hover:text-slate-900 transition-all duration-500 group italic">
              FULL INVENTORY SCAN
              <div className="w-16 h-16 rounded-[1.5rem] border border-black/10 flex items-center justify-center group-hover:bg-primary group-hover:text-slate-900 transition-all duration-500 shadow-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {featuredProductsWithCat?.map((product) => (
              <Link href={`/products?id=${product.id}`} key={product.id} className="group block">
                <div className="aspect-[4/5] relative rounded-[4rem] overflow-hidden bg-black/[0.02] border border-black/10 group-hover:border-primary/50 transition-all duration-1000 shadow-[0_30px_60px_rgba(0,0,0,0.6)] group-hover:shadow-primary/20">
                  ...
                  <div className="absolute bottom-10 left-10 right-10 space-y-4">
                     ...
                     <h3 className="text-2xl font-black text-slate-900 leading-[0.9] group-hover:text-primary transition-colors line-clamp-2 uppercase italic tracking-tighter">{product.name}</h3>
                     <div className="text-xl font-black text-slate-900 tracking-widest italic pt-2">Rs. {product.price.toLocaleString()}</div>
                  </div>
                </div>
              </Link>
            ))}
      ...
      <section className="py-48 border-t border-black/5 relative overflow-hidden">
        <div className="absolute inset-0 bg-primary/2 blur-[250px] rounded-full pointer-events-none" />
        <div className="container mx-auto px-6 max-w-5xl relative z-10">
          <div className="text-center mb-32 space-y-6">
            <div className="inline-flex items-center gap-4 px-6 py-2.5 rounded-full bg-black/5 border border-black/10 italic">
              <HelpCircle className="w-4 h-4 text-slate-700" />
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-slate-700">TECHNICAL QUERIES</span>
            </div>
            <h2 className="text-7xl md:text-9xl font-black text-slate-900 tracking-tighter uppercase italic leading-[0.8]">BLUEPRINT <br /><span className="text-primary italic">INTEL</span></h2>
          </div>
      ...
      <section className="py-48 bg-slate-50 relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none opacity-[0.03] z-0">
           <span className="text-[20vw] font-black text-slate-900 uppercase italic tracking-tighter leading-none select-none">CONTACT</span>
        </div>
        
        <div className="container mx-auto px-6 text-center space-y-20 relative z-10">
          <h2 className="text-6xl md:text-9xl font-black text-slate-900 tracking-tighter uppercase italic leading-none">ELITE <span className="text-primary italic">SUPPORT.</span></h2>
          <div className="flex flex-col lg:flex-row justify-center items-center gap-12">
            <Link 
              href={`https://wa.me/${mainWaNumber}`}
              className="h-24 px-16 bg-primary text-slate-900 font-black uppercase tracking-[0.3em] rounded-[2.5rem] flex items-center gap-6 hover:shadow-[0_20px_60px_rgba(239,68,68,0.5)] transition-all duration-500 transform hover:-translate-y-2 italic group"
            >
              <MessageCircle className="w-8 h-8 group-hover:scale-110 transition-transform" />
              Direct Lab Link
            </Link>
            <div className="hidden lg:flex items-center gap-6 px-10 py-4 bg-black/5 rounded-full border border-black/5 italic">
            ...
            <Link 
              ...
              className="h-24 px-16 bg-black/[0.03] border border-black/10 text-slate-900 font-black uppercase tracking-[0.3em] rounded-[2.5rem] flex items-center gap-6 hover:bg-white/[0.08] hover:border-primary/50 transition-all duration-500 transform hover:-translate-y-2 italic group shadow-2xl"
            >
...
function TrustItem({ icon, title, subtitle }: { icon: React.ReactNode, title: string, subtitle: string }) {
  return (
    <div className="flex items-center gap-6 md:gap-8 group">
      <div className="w-14 h-14 md:w-20 md:h-20 shrink-0 rounded-[1.5rem] bg-black/[0.03] text-primary flex items-center justify-center border border-black/10 transition-all duration-700 group-hover:bg-primary group-hover:text-slate-900 group-hover:scale-110 group-hover:rotate-12 group-hover:shadow-[0_20px_40px_rgba(239,68,68,0.4)] shadow-xl">
        {icon}
      </div>
      <div className="flex flex-col min-w-0 space-y-1">
        <span className="text-slate-900 font-black text-[11px] md:text-lg uppercase tracking-tighter italic truncate leading-none">{title}</span>
...
function CategoryCard({ title, desc, image, href, stats }: { title: string, desc: string, image: string, href: string, stats: string }) {
  return (
    <Link href={href} className="group relative h-[750px] rounded-[5rem] overflow-hidden bg-[#0a0d14] border border-black/10 hover:border-primary/50 transition-all duration-1000 shadow-[0_50px_100px_rgba(0,0,0,0.8)]">
      ...
      <div className="absolute bottom-0 left-0 p-14 md:p-20 space-y-10 w-full z-10">
        ...
        <div className="space-y-4">
           <h3 className="text-6xl md:text-7xl font-black text-slate-900 tracking-tighter leading-none group-hover:text-primary transition-colors uppercase italic">{title}</h3>
           <p className="text-slate-500 font-black text-sm md:text-lg leading-relaxed max-w-sm uppercase italic tracking-tight">{desc}</p>
        </div>
        <div className="pt-6">
          <div className="w-20 h-20 bg-black/5 backdrop-blur-2xl border border-black/10 rounded-[2rem] flex items-center justify-center text-slate-900 group-hover:bg-primary group-hover:text-slate-900 group-hover:scale-110 group-hover:rotate-12 transition-all duration-700 shadow-2xl group-hover:shadow-primary/40">
